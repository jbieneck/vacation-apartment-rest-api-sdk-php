...
class Bootstrap
{
    ...
    {
        spl_autoload_register(array('\VacationApartments\Bootstrap', 'autoload'));
    }
    ...
    {
        spl_autoload_register(array('\VacationApartments\Bootstrap', 'pharAutoload'));
    }
